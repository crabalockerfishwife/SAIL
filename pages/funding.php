...
<body>
	...
	<div class="page-content">
		<div class="page-heading">Financial Aid</div>
		<div class="page-heading-2">University Funding Options</div>
			<button class="accordion">Cornell Financial Aid Office</button>
			<div class="panel">
  				<p>As you begin to think about potential funding sources, make sure to check in with <a href="http://finaid.cornell.edu/types-aid/grants-and-scholarships">Cornell's Financial Aid Office</a>. If you are an aid recipient, they can discuss the financial aid options that are available to you.</p>
			</div>
			...
			<button class="accordion">Mario Einaudi Center for International Studies</button>
			<div class="panel">
  				<p>Because the course has an international element, make sure to check the <a href="http://einaudi.cornell.edu/student-funding">Einaudi Center's </a> list of student funding opportunities to see if you qualify for any of these funding sources.</p>
			</div>
			<button class="accordion">Southeast Asia Program (SEAP)</button>
			<div class="panel">
  				<p><a href="https://seap.einaudi.cornell.edu/funding-opportunities-0">SEAP</a> provides a wide array of funding opportunities for departments, graduate and undergraduate students, and student organizations. </p>
			</div>
